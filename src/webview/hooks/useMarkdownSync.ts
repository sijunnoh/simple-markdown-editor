...
export interface MarkdownSyncRefs {
	...
	isUpdatingFromExtension: React.MutableRefObject<boolean>;
	...
	isEditorEditing: React.MutableRefObject<boolean>;
	lastSyncedMarkdownRef: React.MutableRefObject<string>;
}
